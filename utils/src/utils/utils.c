...
char *desc_code_op[] = {
	...
	"SOLICITAR_CREACION_HILO", "OK_CREACION_HILO", "ERROR_CREACION_HILO","FINAL_HILO","OK_FINAL_HILO", "CANCELAR_HILO","ENVIAR_EXEC", "EXEC_RECIBIDO","FIN_QUANTUM",
	...
	"HILO_CANCEL", "IO_SOLICITADA","MEM_DUMPEADA","SOL_DUMP", "MEM_DUMP_ERROR", "OK", "HILO_NO_JOINEADO", "SEGMENTATION_FAULT"};
