...
char *desc_code_op[] = {
	...
	"SOLICITAR_CREACION_HILO", "OK_CREACION_HILO", "ERROR_CREACION_HILO","FINAL_HILO","OK_FINAL_HILO", "CANCELAR_HILO","ENIVAR_EXEC", "OK_EJECUCION","FIN_QUANTUM",
	"DESALOJO_POR_QUANTUM","OK_FIN_QUANTUM"};
